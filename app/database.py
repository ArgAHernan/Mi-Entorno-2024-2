#codigos y funciones para comunicarnos con la BD, cerrarla, etc

import os
import mysql.connector
from flask import g  #espacio de memoria para guardar instancias de conexion
from dotenv import load_dotenv #carga las variables de entorno

# Cargar variables de entorno desde el archivo .env
load_dotenv()

DATABASE_CONFIG = {  #coincide con lo guardado en .env
